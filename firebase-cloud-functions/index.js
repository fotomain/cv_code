...
exports.do_send_email = onDocumentCreated("/port_otp_for_check/{docId}", (event) => {
    ...
    const ret = nodemailer_handler.sendMail({
...
//                 console.log('========================== ')
//                 console.log('========================== ')
//                 console.log('=== port_otp_input return 111 ', ret)
//                 console.log('========================== ')
//                 console.log('========================== ')
//                 console.log('========================== ')
//                 console.log('=== finish ');
...
//     console.log('========================== ')
//     console.log('========================== ')
//     console.log('=== port_otp_input return 222  ret_all ',ret_all)
//     console.log('========================== ')
//     console.log('========================== ')
//     console.log('========================== ')

//      return db.collection('answers').add({
//             text: JSON.stringify(ret_all),
//     });
